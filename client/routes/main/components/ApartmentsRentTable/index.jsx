...
class ApartmentsRentTable extends React.Component {
	constructor() {
		super();
...
function mapStateToProps(state) {
	return {
		...
		filteredList: state.filter.data.apartment_rent
	};
}
...
export default connect(mapStateToProps, mapDispatchToProps)(ApartmentsRentTable);
