		...
		const
			...
			rows = (data != null) && _.map(data, I => {
				...
				const
					...
					communications = [
						{id: 1, val: I.communic_water},
						{id: 2, val: I.communic_gas},
						{id: 3, val: I.communic_electricity},
						{id: 4, val: I.communic_phone},
						{id: 5, val: I.communic_canalisation}
					],

					communicationsStr = orNone(matchArrEqualObjProps(
						communications.filter(x => x.val > 2),
...
function mapStateToProps(state) {
	return {
		...
		filteredList: state.filter.data.land
	};
}
...
export default connect(mapStateToProps, mapDispatchToProps)(LotsTable);
